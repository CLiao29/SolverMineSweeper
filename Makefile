...
all: 	  
	  nvcc -std=c++11 parsolver.cu -O3 -arch=sm_70 -c -o objs/parsolve.o -g
	  nvcc -std=c++11 sharedparsolver.cu -O3 -arch=sm_70 -c -o objs/sharedparsolve.o -g
	  g++ -std=c++11 -m64 -O3 -Wall -o minesweeper main.cpp game.cpp objs/parsolve.o objs/sharedparsolve.o ompsolver.cpp seqsolver.cpp -L/sw/pkgs/arc/cuda/12.1.1/lib64/  -lcudart -g -fopenmp -DOMP
